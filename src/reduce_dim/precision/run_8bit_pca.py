...
from model import transform_to_8
import argparse
...
def performance_8(data):
    ...
    dataReduced = {
        "queries": transform_to_8(dataReduced["queries"]),
        "docs": transform_to_8(dataReduced["docs"])
    }
...
logdata = []
val_ip, val_l2 = performance_8(data)
logdata.append({
