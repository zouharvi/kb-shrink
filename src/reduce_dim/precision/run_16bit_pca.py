...
from model import transform_to_16
import argparse
...
def performance_16(data):
    ...
    dataReduced = {
        "queries": transform_to_16(dataReduced["queries"]),
        "docs": transform_to_16(dataReduced["docs"])
    }
...
logdata = []
val_ip, val_l2 = performance_16(data)
logdata.append({
